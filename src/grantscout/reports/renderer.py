...
from grantscout.models.schemas import ResearchState
...
def render_markdown(state: ResearchState) -> str:
    ...
    lines = [f"# GrantScout Report: {state.question}", "", "## Executive Summary", ""]
    lines.append(
        "- System synthesis: "
...
<html lang="en"><head><meta charset="utf-8"><title>GrantScout Report</title>
...
<h1>GrantScout Report: {escape(state.question)}</h1>
...
_ZH_REPORT_COPY = {
    ...
    "GrantScout Report": "GrantScout 研究笔记",
