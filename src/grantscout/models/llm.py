...
_UNCLOSED_THINKING_PATTERN = re.compile(r"<think>.*\Z", re.DOTALL | re.IGNORECASE)


def strip_thinking(content: str) -> str:
    """Remove reasoning blocks, including ones truncated mid-thinking."""
    cleaned = _THINKING_PATTERN.sub("", content)
...
class OpenAICompatibleClient:
    ...
    def __init__(
        ...
        self.local_loopback = not allow_research_endpoint
    ...
    def chat(
        ...
        elif self.local_loopback:
            # vLLM-specific default; remote OpenAI-compatible endpoints reject it.
