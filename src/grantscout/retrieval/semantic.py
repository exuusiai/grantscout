...
def _arch_compatible(capability: tuple[int, int], supported_arches: list[str]) -> bool:
    """Same-major lower-minor kernels are binary compatible (sm_86 runs on sm_89)."""
...
class SemanticIndex:
    ...
    def _load_model(self) -> Any:
        ...
        configured_device = os.getenv("GRANTSCOUT_EMBEDDING_DEVICE")
        if configured_device:
            ...
            try:
                ...
                if torch.cuda.is_available():
                    ...
                    if supported_architectures and not _arch_compatible(capability, supported_architectures):
                        resolved_device = "cpu"
    ...
    def search(
        ...
        for score, index in ranked:
            ...
            if paper_ids is not None and metadata["evidence"]["paper_id"] not in paper_ids:
                continue
            from grantscout.models.schemas import EvidenceItem, Paper
