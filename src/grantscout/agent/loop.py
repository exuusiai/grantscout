...
from grantscout.models.schemas import Claim, ResearchConstraints, ResearchDecision, ResearchState, StructuredFacts, ToolCall
...
from grantscout.tools.comparison import assess_comparability, compare_papers, find_contradictions
...
class GrantScoutAgent:
    ...
    def _persist(self, state: ResearchState) -> None:
        ...
        from grantscout.reports.renderer import render_html
